...
module.exports = function(RED) {
    ...
    var url = require('url');
    var CryptoJS = require("./lib/core");
    var encrypt = require("./lib/cipher-core");
    var AES = require("./lib/aes");
    var encUtf8 = require('./lib/enc-utf8');               
    ...
    function MQTTBrokerNode(n) {
        ...
        this.broker = "myipedit.com"//n.broker;
        this.port = 8883//n.port;
        this.clientid = n.clientid;
        this.usetls = true//n.usetls;
        this.usews = n.usews;
        this.verifyservercert = true//n.verifyservercert;
        this.compatmode = true//n.compatmode;
        ...
        if (this.credentials) {
            this.username = "phone_user";
            this.password = "NHY2007#zy_edc88";
        }
        ...
        if (this.compatmode == "true" || this.compatmode === true) {
            ...
            this.options.protocolVersion = 3;
						//this.options.ca = 'aa';
            this.options.ca ='-----BEGIN CERTIFICATE-----\n' +
  'MIID7TCCAtWgAwIBAgIJALIDzyJGUdGbMA0GCSqGSIb3DQEBCwUAMIGMMQswCQYD\n' +
  'VQQGEwJDTjEQMA4GA1UECAwHR3VhbmdYaTEQMA4GA1UEBwwHTmFubmluZzEQMA4G\n' +
  'A1UECgwHQXZpb3N5czERMA8GA1UECwwIU29mdHdhcmUxFTATBgNVBAMMDG15aXBl\n' +
  'ZGl0LmNvbTEdMBsGCSqGSIb3DQEJARYOaHlAYXZpb3N5cy5jb20wHhcNMTkwMzAy\n' +
  'MDQyNzQ5WhcNMjkwMjI3MDQyNzQ5WjCBjDELMAkGA1UEBhMCQ04xEDAOBgNVBAgM\n' +
  'B0d1YW5nWGkxEDAOBgNVBAcMB05hbm5pbmcxEDAOBgNVBAoMB0F2aW9zeXMxETAP\n' +
  'BgNVBAsMCFNvZnR3YXJlMRUwEwYDVQQDDAxteWlwZWRpdC5jb20xHTAbBgkqhkiG\n' +
  '9w0BCQEWDmh5QGF2aW9zeXMuY29tMIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIB\n' +
  'CgKCAQEAuawqWPtfMBorN6QmglH+suW1fZTnwm/vBuyAXlg72EZEbPdeLG7lT5Yk\n' +
  '+mP5kCcoM0bzw04hCnIZ5pnuGsybU7kS1Y/7ldMgW/euaTkbtUCihemHmb9nh6tK\n' +
  'Og3IcVtebE1FjqoteiIBjHeQWuR/J8J/BFGqYPg5/bItL69KeeCbpYdmFtjfUIoy\n' +
  'TcCvBHKFDHBYRCjjG3JJ3ZCFNIMtyHJFyGP8MR+rtMATalmDA9LvtWiibsbETK7R\n' +
  '7IRHb/hiG6cH74EGgPvbkznq9jXbA1/ucSoPhj7YgiVpefHHIlWk4ZUAfuIN0OKx\n' +
  'aAv8b1xW14WYCw8pci1cTzf+96CmtwIDAQABo1AwTjAdBgNVHQ4EFgQUjI7SSNCZ\n' +
  'vZ+lrclFYoTwAyyBWMcwHwYDVR0jBBgwFoAUjI7SSNCZvZ+lrclFYoTwAyyBWMcw\n' +
  'DAYDVR0TBAUwAwEB/zANBgkqhkiG9w0BAQsFAAOCAQEAM8W9G/2KZPUr1uCQgf8E\n' +
  'gRQ8oAHp1T6+DJybAxmcFZxQMYQTPO/Rm4kb3NJpi3u3sLWirRWLiqoDR94td+PH\n' +
  'k756mdlwDQg5or1y15LoWQ64FCPU+ddG8j66+50roiHP02jYJgYqBW3I7Xan0TOM\n' +
  'hxAhBSbtr/JBA1ZjXVQD8PRTAtoQ7B8aFT5KQsuWuajHCD7lUleB5ORIwRgjWPoc\n' +
  'NuKqQLEzQfc3S/RUDrs/dxOLJ7CNaKOgbKhbhSY+UxA0S7Y4vETxIpHk5fZoA0+V\n' +
  'k18ucot3HaZyHhExbozQ37LDalcBoXJ0jiyDmZyjL1lpnZas+kvce1sZFJ3ZQqCG\n' +
  'EQ==\n' +
  '-----END CERTIFICATE-----';
    ...
    RED.nodes.registerType("mqtt-aviosys-broker",MQTTBrokerNode,{
        credentials: {
            user: {type:"text"},
    ...
    RED.nodes.registerType("mqtt-aviosys in",MQTTInNode);

    function MQTTOutNode(n) {
        RED.nodes.createNode(this,n);
        this.topic = n.topic;
        this.qos = n.qos1 || null;
            ...
            this.on("input",function(msg,send,done) {
                ...
                if ( msg.hasOwnProperty("payload")) {
                    if (msg.hasOwnProperty("topic") && (typeof msg.topic === "string") && (msg.topic !== "")) { // topic must exist
                        ...
                        var encrypted=CryptoJS.AES.encrypt(msg.payload,encUtf8.parse((msg.password+"H7%y6#t8_p8Ah6$9").substring(0,16)),{iv:encUtf8.parse("h8_Ydw#avio%+5uM")}).toString();
    ...
    RED.nodes.registerType("mqtt-aviosys out",MQTTOutNode);
